            ...
            <div className="w-full max-w-[760px] space-y-10 md:space-y-12">
                ...
                <main className="space-y-12">
                    <section className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold text-white">1. Acceptance</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold text-white">2. What CONTINUE-X Does</h2>
                        <p className="text-[#64748B] leading-relaxed text-base md:text-xl">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold text-white">3. Acceptable Use</h2>
                        <p className="text-[#64748B] leading-relaxed text-base md:text-xl">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold text-white">4. No Warranty</h2>
                        <p className="text-[#64748B] leading-relaxed text-base md:text-xl">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold text-white">6. Changes</h2>
                        <p className="text-[#64748B] leading-relaxed text-base md:text-xl">
